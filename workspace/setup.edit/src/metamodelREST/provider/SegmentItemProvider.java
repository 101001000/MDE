...
/**
 * This is the item provider adapter for a {@link metamodelREST.Segment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SegmentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Segment_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Segment_value_feature", "_UI_Segment_type"),
				 MetamodelRESTPackage.Literals.SEGMENT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Segment)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Segment.class)) {
			case MetamodelRESTPackage.SEGMENT__VALUE:
