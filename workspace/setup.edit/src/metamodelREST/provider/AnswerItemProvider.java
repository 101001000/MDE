...
/**
 * This is the item provider adapter for a {@link metamodelREST.Answer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnswerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Answer_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Answer_status_feature", "_UI_Answer_type"),
				 MetamodelRESTPackage.Literals.ANSWER__STATUS,
				 true,
				 false,
				 false,
	...
	protected void addReturnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Answer_return_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Answer_return_feature", "_UI_Answer_type"),
				 MetamodelRESTPackage.Literals.ANSWER__RETURN,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Answer_type") + " " + answer.getStatus();
	}
