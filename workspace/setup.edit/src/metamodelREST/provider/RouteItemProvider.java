...
/**
 * This is the item provider adapter for a {@link metamodelREST.Route} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Route_segment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Route_segment_feature", "_UI_Route_type"),
				 MetamodelRESTPackage.Literals.ROUTE__SEGMENT,
				 true,
				 false,
				 true,
				 null,
