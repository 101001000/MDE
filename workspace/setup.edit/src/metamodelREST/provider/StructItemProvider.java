...
/**
 * This is the item provider adapter for a {@link metamodelREST.Struct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Struct_fields_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Struct_fields_feature", "_UI_Struct_type"),
				 MetamodelRESTPackage.Literals.STRUCT__FIELDS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Struct)object).getFields();
