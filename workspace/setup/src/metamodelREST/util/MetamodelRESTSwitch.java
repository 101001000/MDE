 ...
 * @generated
 */
public class MetamodelRESTSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MetamodelRESTPackage.REQUEST: {
			...
			case MetamodelRESTPackage.DATA: {
			...
			case MetamodelRESTPackage.OPERATION: {
