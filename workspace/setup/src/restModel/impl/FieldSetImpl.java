 ...
 * @generated
 */
public class FieldSetImpl extends MinimalEObjectImpl.Container implements FieldSet {
	/**
	...
	protected EClass eStaticClass() {
		return RestModelPackage.Literals.FIELD_SET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestModelPackage.FIELD_SET__NAME, oldName, name));
	}
