 ...
 * </p>
 * <ul>
 *   <li>{@link restModel.impl.OpUpdateImpl#getFieldset <em>Fieldset</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpUpdateImpl extends OperationImpl implements OpUpdate {
	...
	public EList<FieldSet> getFieldset() {
		if (fieldset == null) {
			fieldset = new EObjectContainmentEList<FieldSet>(FieldSet.class, this, RestModelPackage.OP_UPDATE__FIELDSET);
		}
		return fieldset;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RestModelPackage.OP_UPDATE__FIELDSET:
