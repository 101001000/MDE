...
public class AnswerImpl extends MinimalEObjectImpl.Container implements Answer {
	...
	protected EClass eStaticClass() {
		return RestModelPackage.Literals.ANSWER;
	}
	...
	public void setStatus(int newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestModelPackage.ANSWER__STATUS, oldStatus, status));
	}
	...
	public void setReturn(String newReturn) {
		...
		return_ = newReturn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestModelPackage.ANSWER__RETURN, oldReturn, return_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RestModelPackage.ANSWER__STATUS:
				return getStatus();
