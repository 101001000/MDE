...
public class RestSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *         (fieldset+=[FieldSet|EString] fieldset+=[FieldSet|EString]*)?
	 *     )
	 */
	 ...
	 *
	 * Constraint:
	 *     (id=EString? failedAnswer=[Answer|EString]? succAnswer=[Answer|EString]? struct=[Struct|EString])
	 */
	 ...
	 *
	 * Constraint:
	 *     (fields=EString? id=EString? failedAnswer=[Answer|EString]? succAnswer=[Answer|EString]? struct=[Struct|EString])
	 */
	 ...
	 *
	 * Constraint:
	 *     (route=[Route|EString] (data+=[Data|EString] data+=[Data|EString]*)? (ops+=[Operation|EString] ops+=[Operation|EString]*)?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (segment+=[Segment|EString] segment+=[Segment|EString]*)
	 */
